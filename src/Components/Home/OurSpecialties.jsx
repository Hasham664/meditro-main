...
const OurSpecialties = () => {
  ...
  return (
    <section className="text-center py-10 Mycontainer">
      {/* Title */}
      <h2 className="text-[#0069AB] font-bold uppercase pt-8">Always Caring</h2>
      <h3 className="text-4xl font-bold text-teal-600 mt-2">Our Specialties</h3>

      {/* Grid */}
      <div className="grid grid-cols-2 gap-4 md:gap-0 lg:gap-0 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  mt-8 mb-2   p-0 lg:p-4 md:p-4">
        {specialties.map((specialty, index) => (
          <Link href={specialty.link} key={index}>
            <div
              key={index}
